      ...
      >
        ...
        >
          ...
          <p className="text-xl text-white/70 max-w-xl mx-auto">
            Test your knowledge of iconic movie and anime quotes. Can you guess who said what?
          </p>
        </motion.div>
        ...
        >
          {loading ? (
            <div className="text-center text-white/60 text-lg">Loading a great quote...</div>
          ) : (
            quote && (
              <QuoteCard
                quote={quote.quote}
        ...
        >
          <motion.button
            ...
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.97 }}
            className="px-8 py-3 rounded-xl backdrop-blur-lg bg-white/10 border border-white/20 font-semibold text-lg hover:bg-white/15 transition-all duration-300 shadow-lg disabled:opacity-50"
          >
            🔄 Get Another Quote
          </motion.button>
          ...
          <Link to="/game" className="block">
            <motion.button
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.97 }}
              className="px-8 py-3 rounded-xl backdrop-blur-lg bg-amber-500/30 border border-amber-400 font-semibold text-lg hover:bg-amber-500/40 transition-all duration-300 shadow-lg shadow-amber-400/30"
            >
              🎮 Play Game
            </motion.button>
          </Link>
        ...
        >
          Challenge yourself with 10 questions and earn your spot on the quote leaderboard!
        </motion.p>
      </motion.div>
    </div>
  );
